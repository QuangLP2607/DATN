...
type SelectFieldKey = "japaneseLevel";
type TextFieldKey = Exclude<ProfileField, DateFieldKey | SelectFieldKey>;
...
type SelectField = BaseField<SelectFieldKey> & {
  type: "select";
  options: readonly string[];
};

type FieldConfig = TextField | DateField | SelectField;
        ...
        <div className={cx("avatar")}>
          <div className={cx("avatar__frame")}>
            {avatarFile ? (
              ...
              <div className={cx("avatar__fallback")}>
